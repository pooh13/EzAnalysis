# Generated by Django 3.2.3 on 2021-07-12 17:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('things_img', models.ImageField(null=True, upload_to='things')),
            ],
        ),
        migrations.CreateModel(
            name='Diary',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('diary_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AI_analyze.diary')),
